...
import {allJojoProducts} from '../helpers/jojoProducts';

const JojoCartItemComponent = ({item}) => {
  ...
  const productImage = allJojoProducts.find(p => p.name === item.name)?.image;
...
export default JojoCartItemComponent;
